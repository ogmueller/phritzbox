 ...
 */
final class Version20190903213522 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__smart_device_data AS SELECT data_id, sid, type, time, value FROM smart_device_data');
        $this->addSql('DROP TABLE smart_device_data');
        $this->addSql('CREATE TABLE smart_device_data (data_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sid VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, time DATETIME NOT NULL, value DOUBLE PRECISION NOT NULL)');
        $this->addSql('INSERT INTO smart_device_data (data_id, sid, type, time, value) SELECT data_id, sid, type, time, value FROM __temp__smart_device_data');
        $this->addSql('DROP TABLE __temp__smart_device_data');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__smart_device_data AS SELECT data_id, sid, type, time, value FROM smart_device_data');
        $this->addSql('DROP TABLE smart_device_data');
        $this->addSql('CREATE TABLE smart_device_data (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sid VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, time DATETIME NOT NULL, value DOUBLE PRECISION NOT NULL, data_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO smart_device_data (data_id, sid, type, time, value) SELECT data_id, sid, type, time, value FROM __temp__smart_device_data');
        $this->addSql('DROP TABLE __temp__smart_device_data');
        $this->addSql('DROP INDEX IDX_53AD8F834B89032C');
        $this->addSql('DROP INDEX IDX_53AD8F83F675F31B');
