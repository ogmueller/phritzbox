 ...
 */
final class Version20190903212829 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE smart_device_data (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, data_id INTEGER NOT NULL, sid VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, time DATETIME NOT NULL, value DOUBLE PRECISION NOT NULL)');
